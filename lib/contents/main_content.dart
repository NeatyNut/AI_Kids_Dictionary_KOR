...
// <-- Main List Contents -->
/*
* List를 클릭할시 넘어갈 페이지, 이미지, 컨텐츠의 이름, 백그라운드 컬러만 변경 가능하게하여
* 기본 요소는 고정값으로 들어가게 설정해놓은 모듈화
* */
...
/*
* 현재 제외된 항목이나, Carousel Slider를 사용하여 서버에 권한요청을하여, 현재 항목들의 리스트를
* 거꾸로 뒤집은뒤 갯수를 지정하여 호출하는 모듈
* */
